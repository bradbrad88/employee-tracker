...
const addEmployee = async ({ back }) => {
  ...
  try {
    ...
    dbSuccess(answers.firstName + " successfully added to database!");
  } catch (error) {
    dbFail("Failed to add employee to the database.");
  }
  await back();
};
...
const updateEmployeeRole = async ({ back }) => {
  ...
  const { firstName } = await getEmployeeDetails(employee);
  ...
  try {
    await query(sql, params);
    dbSuccess(`Successfully updated ${firstName}'s role!`);
  } catch (error) {
    dbFail("Failed to update employee's role.");
  }
  await back();
};
...
const updateEmployeeManager = async ({ back }) => {
  try {
    ...
    const { firstName, department } = await getEmployeeDetails(employee);
    ...
    await query(sql, params);
    dbSuccess(`Successfully updated ${firstName}'s manager!`);
  } catch (error) {
    dbFail("Failed to update employee's manager.");
  }
  await back();
};
...
const deleteEmployee = async ({ back }) => {
  ...
  try {
    ...
    dbSuccess(`Successfully removed ${firstName} from the database!`);
  } catch (error) {
    dbFail("Failed to remove employee from the database.");
  }
  await back();
};
